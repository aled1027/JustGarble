...
int
XORCircuit(GarbledCircuit *gc, GarblingContext *ctxt, int n,
           int* inputs, int* outputs);
int
NOTCircuit(GarbledCircuit *gc, GarblingContext *ctxt, int n,
           int* inputs, int* outputs);
int
ANDCircuit(GarbledCircuit *gc, GarblingContext *ctxt, int n,
           int* inputs, int* outputs);
int
...
int
SBOXNOTABLE(GarbledCircuit *gc, GarblingContext *ctxt,
            int* inputs, int* outputs);
int
AddRoundKey(GarbledCircuit *gc, GarblingContext *ctxt, int* inputs,
            int* outputs);
int
SubBytes(GarbledCircuit *gc, GarblingContext *ctxt, int* inputs,
         int* outputs);
int
SubBytesTable(GarbledCircuit *gc, GarblingContext *ctxt, int* inputs,
              int* outputs);
int
ShiftRows(GarbledCircuit *gc, GarblingContext *ctxt, int* inputs,
          int* outputs);
int
MixColumns(GarbledCircuit *gc, GarblingContext *ctxt, int* inputs,
           int* outputs);
int
...
MULTE_GF16(GarbledCircuit *gc, GarblingContext *ctxt,
           int* inputs, int* outputs);
int
INV_GF16(GarbledCircuit *gc, GarblingContext *ctxt,
         int* inputs, int* outputs);
int
AFFINE(GarbledCircuit *gc, GarblingContext *ctxt,
       int* inputs, int* outputs);
int
...
INVMAP(GarbledCircuit *gc, GarblingContext *ctxt, int* inputs,
       int* outputs);
int
GF8MULCircuit(GarbledCircuit *gc, GarblingContext *ctxt,
              int n, int* inputs, int* outputs);

int
EncoderCircuit(GarbledCircuit *gc, GarblingContext *ctxt,
               int* inputs, int* outputs, int enc[]);
int
GF4MULCircuit(GarbledCircuit *gc, GarblingContext *ctxt,
              int* inputs, int* outputs);
int
GF4SQCircuit(GarbledCircuit *gc, GarblingContext *ctxt,
             int* inputs, int* outputs);
int
GF4SCLNCircuit(GarbledCircuit *gc, GarblingContext *ctxt,
               int* inputs, int* outputs);
int
...
int
NewSBOXCircuit(GarbledCircuit *gc, GarblingContext *ctxt,
               int* inputs, int* outputs);
int
GF256InvCircuit(GarbledCircuit *gc, GarblingContext *ctxt,
                int* inputs, int* outputs);
int
GF16INVCircuit(GarbledCircuit *gc, GarblingContext *ctxt,
               int* inputs, int* outputs);
